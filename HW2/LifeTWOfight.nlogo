...
to setup-n-acorns-vs-random
  ...
  let i 0
  repeat n-acorns [
  setupacorn red -80 (-125 + (i * 10))
  set i i + 1
  ]

  set i 0
  repeat n-acorns [
  setupacorn red -120 (-125 + (i * 10))
  set i i + 1
  ]
...
"pen-2" 1.0 0 -2674135 true "" "plot count patches with [pcolor = red]"
"pen-3" 1.0 0 -7500403 true "" "plot count patches with [pcolor = brown]"
"pen-4" 1.0 0 -13345367 true "" "plot count patches with [pcolor = blue]"
